...
class TestReplace:
    ...
    def test_mastodon_links(self) -> None:  # noqa: ANN101
        ...
        assert (
            username_with_link(link_and_twitter)
            == "https://mastodon.gamedev.place/@eloraam?hello#something [@eloraam](https://twitter.com/eloraam) #Hello"
        )
        assert hashtag_with_link(link) == link
        assert (
            hashtag_with_link(link_and_twitter)
            == "https://mastodon.gamedev.place/@eloraam?hello#something @eloraam [#Hello](https://twitter.com/hashtag/Hello)"  # noqa: E501
        )
