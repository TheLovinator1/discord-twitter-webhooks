...
webhook_url_error = os.environ["WEBHOOK_URL_ERROR"]
webhook_url = os.environ["WEBHOOK_URL"]

# Log severity. Can be CRITICAL, ERROR, WARNING, INFO or DEBUG
log_level = os.getenv("LOG_LEVEL", default="INFO")

# Discord ID for owner. Will get pinged when bot encounters error.
...
if __name__ == "__main__":
    ...
    print(f"Webhook url for errors: {webhook_url_error}")
    print(f"Webhook url: {webhook_url}")
    print(f"Discord owner ID: {owner_id}")
